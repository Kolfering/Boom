...
void Case::calculApparitionBonus()
{
    ...
    if(nombre2<= PROBABILITY_SUR_100)
    {
        ...
        if(nombre3 >= 1 && nombre3 <= PROBABILITY_GRANDSOIN)
                Carte::ajouterBonus(new BonusGrandSoin(this));
        else if (nombre3 >= PROBABILITY_GRANDSOIN + 1 && nombre3 <= PROBABILITY_VITESSE + PROBABILITY_GRANDSOIN + 1)    
                Carte::ajouterBonus(new BonusVitesse(this));
        else if (nombre3 >= PROBABILITY_VITESSE + PROBABILITY_GRANDSOIN + 2 && nombre3 <= PROBABILITY_BOMBE_RAPIDE + PROBABILITY_VITESSE + PROBABILITY_GRANDSOIN + 2)
                Carte::ajouterBonus(new BonusBombeRapide(this));
        else if (nombre3 >= PROBABILITY_BOMBE_RAPIDE + PROBABILITY_VITESSE + PROBABILITY_GRANDSOIN + 3 && nombre3 <= PROBABILITY_PETITSOIN + PROBABILITY_BOMBE_RAPIDE + PROBABILITY_VITESSE + PROBABILITY_GRANDSOIN + 3)
                Carte::ajouterBonus(new BonusPetitSoin(this));
        else if (nombre3 >= PROBABILITY_PETITSOIN + PROBABILITY_BOMBE_RAPIDE + PROBABILITY_VITESSE + PROBABILITY_GRANDSOIN + 4 && nombre3 <= PROBABILITY_TETE_DE_MORT + PROBABILITY_PETITSOIN + PROBABILITY_BOMBE_RAPIDE + PROBABILITY_VITESSE + PROBABILITY_GRANDSOIN + 4)
                Carte::ajouterBonus(new BonusTeteDeMort(this));
        else if (nombre3 >= PROBABILITY_TETE_DE_MORT + PROBABILITY_PETITSOIN + PROBABILITY_BOMBE_RAPIDE + PROBABILITY_VITESSE + PROBABILITY_GRANDSOIN + 5 && nombre3 <= PROBABILITY_ECLAIR + PROBABILITY_TETE_DE_MORT + PROBABILITY_PETITSOIN + PROBABILITY_BOMBE_RAPIDE + PROBABILITY_VITESSE + PROBABILITY_GRANDSOIN + 5)
                Carte::ajouterBonus(new BonusEclair(this));
        else if (nombre3 >= PROBABILITY_ECLAIR + PROBABILITY_TETE_DE_MORT + PROBABILITY_PETITSOIN + PROBABILITY_BOMBE_RAPIDE + PROBABILITY_VITESSE + PROBABILITY_GRANDSOIN + 6 && nombre3 <= PROBABILITY_PROTECTION + PROBABILITY_ECLAIR + PROBABILITY_TETE_DE_MORT + PROBABILITY_PETITSOIN + PROBABILITY_BOMBE_RAPIDE + PROBABILITY_VITESSE + PROBABILITY_GRANDSOIN + 6)
                Carte::ajouterBonus(new BonusProtection(this));
        else if (nombre3 >= PROBABILITY_PROTECTION + PROBABILITY_ECLAIR + PROBABILITY_TETE_DE_MORT + PROBABILITY_PETITSOIN + PROBABILITY_BOMBE_RAPIDE + PROBABILITY_VITESSE + PROBABILITY_GRANDSOIN + 7 && nombre3 <= PROBABILITY_EXPLOSION + PROBABILITY_PROTECTION + PROBABILITY_ECLAIR + PROBABILITY_TETE_DE_MORT + PROBABILITY_PETITSOIN + PROBABILITY_BOMBE_RAPIDE + PROBABILITY_VITESSE + PROBABILITY_GRANDSOIN + 7)
                Carte::ajouterBonus(new BonusDistanceExplosion(this));
        else if (nombre3 >= PROBABILITY_EXPLOSION + PROBABILITY_PROTECTION + PROBABILITY_ECLAIR + PROBABILITY_TETE_DE_MORT + PROBABILITY_PETITSOIN + PROBABILITY_BOMBE_RAPIDE + PROBABILITY_VITESSE + PROBABILITY_GRANDSOIN + 8 && nombre3 <= PROBABILITY_NOMBRE_BOMBE + PROBABILITY_EXPLOSION + PROBABILITY_PROTECTION + PROBABILITY_ECLAIR + PROBABILITY_TETE_DE_MORT + PROBABILITY_PETITSOIN + PROBABILITY_BOMBE_RAPIDE + PROBABILITY_VITESSE + PROBABILITY_GRANDSOIN + 8)
